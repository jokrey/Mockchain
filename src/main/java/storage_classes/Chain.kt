...
import squash.SquashAlgorithmState
import squash.VirtualChange
import java.util.*
...
class Chain(val app:Application,
    ...
    fun performConsensusRound(forceSquash: Boolean = false) {
        ...
        do {
            ...
            newSquashState = squash.findChanges(this, app.getPartialReplaceSquashHandler(), app.getBuildUponSquashHandler(), app.getSequenceSquashHandler(),
