...
class DistributedTests {
    ...
    fun simpleTest3Nodes() {
        ...
        val instance1_consensus = (instance1.consensus as ManualConsensusAlgorithm)
        ...
        instance1_consensus.performConsensusRound(0)
    ...
    fun distributedWithSquash() {
        ...
        instance1_consensus.performConsensusRound(-1)
...
//        helper_assertEquals(instance3.chain.getPersistedTransactions().asSequence(), tx0, tx1, tx2)
    ...
    fun forkTestSimple1() {
        ...
        val instance1_consensus = (instance1.consensus as ManualConsensusAlgorithm)
        val instance2_consensus = (instance2.consensus as ManualConsensusAlgorithm)
        ...
        instance1.commitToMemPool(tx1)
        sleep(100)
        instance2_consensus.performConsensusRound(0)
        sleep(100)
        instance2.commitToMemPool(tx2)
        sleep(100)
        instance1_consensus.performConsensusRound(0)
    ...
    fun forkTestSimple2_manyBlocks() {
        ...
        for(i in 2500 until 2510) {
            ...
            instance1_consensus.performConsensusRound(0) //after first consensus round the synchronization has occurred
...
//        helper_assertEquals(instance2.chain.getPersistedTransactions().asSequence(), tx0, tx1, tx2, tx3, tx4, tx5, tx6, tx7)
    ...
    fun forkTestSimple_concurrentToPerform_pauseTest() {
        ...
        val instance1_consensus = (instance1.consensus as ManualConsensusAlgorithm)
        val instance2_consensus = (instance2.consensus as ManualConsensusAlgorithm)
        val instance3_consensus = (instance3.consensus as ManualConsensusAlgorithm)
        ...
        Thread {
            ...
            instance3_consensus.performConsensusRound(0)
            for (i in 0 until 5)
